...
public class DriverMatchTaskApplication implements TaskApplication {
    ...
    public void describe(TaskApplicationDescriptor taskApplicationDescriptor) {
        ...
        KafkaInputDescriptor kafkaInputDriverDescriptor =
                kafkaSystemDescriptor.getInputDescriptor("driver-locations", new JsonSerde<>());
        KafkaInputDescriptor kafkaInputEventDescriptor =
        ...
        // Set the input
        taskApplicationDescriptor.withInputStream(kafkaInputDriverDescriptor);
        taskApplicationDescriptor.withInputStream(kafkaInputEventDescriptor);
        // Set the output
